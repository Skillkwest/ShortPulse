...
| D    | In Progress | Engineering | `D1-01` and `D1-02` are complete; `D1-03` is next on `DetailModal` avatar-flow warning removal                                         | Remaining strict-runtime debt is now isolated to `DetailModal`; full-suite baseline is still red on unrelated admin ledger assertion | `D1-03` detail-modal avatar hardening                                     | `docs/planning/lane-d-master-plan-2026-03-16.md`                        |
