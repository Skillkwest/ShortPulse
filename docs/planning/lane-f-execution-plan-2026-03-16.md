...
| `F1-01` | F1 | CI inventory and required-check policy | Align workflow job inventory and CI policy docs, including rollback verification coverage | `docs/planning/evidence/lane-f/2026-03-17-f1-01-ci-inventory-required-check-contract.md` | Not Started |
| `F2-01` | F2 | Plan-limited enforcement model | Refresh branch/ruleset compensating controls and current waiver posture | `docs/planning/evidence/lane-f/2026-03-17-f2-01-plan-limited-enforcement-model.md` | Not Started |
