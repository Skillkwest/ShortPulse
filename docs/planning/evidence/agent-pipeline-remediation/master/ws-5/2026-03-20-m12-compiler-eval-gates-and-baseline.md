...
Baseline artifact:
1. `docs/planning/evidence/agent-pipeline-remediation/master/ws-5/artifacts/2026-03-20/compiler-eval-gates-baseline.json`

Referenced historical corpus artifacts (Phase 2):
1. `docs/planning/evidence/agent-pipeline-remediation/phase-2/artifacts/2026-03-20/local-safety-sim-aggregates.json`
2. `docs/planning/evidence/agent-pipeline-remediation/phase-2/artifacts/2026-03-20/staging-safety-sim-aggregates.json`
3. `docs/planning/evidence/agent-pipeline-remediation/phase-2/artifacts/2026-03-20/staging-safety-sim-summary.json`
...
5. `docs/planning/evidence/agent-pipeline-remediation/phase-2/2026-03-20-phase-2-continuity-guard-validation.md`
