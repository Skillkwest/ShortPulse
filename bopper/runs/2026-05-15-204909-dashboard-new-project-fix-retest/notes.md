...
- Run brief path: `bopper/runs/2026-05-15-204909-dashboard-new-project-fix-retest/run-brief.md`
- Detailed report path: `bopper/reports/2026-05-15-local-dashboard-new-project-fix-retest.md`
- Checkpoint summary path: `bopper/checkpoint-summaries/2026-05-15-local-dashboard-new-project-fix-retest-summary.md`
