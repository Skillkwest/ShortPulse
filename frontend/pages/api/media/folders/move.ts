/**
 * Moves a custom media folder to a new parent for the authenticated user.
 */
...
/**
 * Handles custom folder reparent operations.
 */
export default async function handler(
  ...
  try {
    ...
    const folder = await moveMediaFolderForUser({
      userId: user.id,
      folderId,
      parentFolderId,
    });
