...
- `bopper/runs/<timestamp>-<slug>/packet.json`
- `bopper/runs/<timestamp>-<slug>/run-brief.md`
- `bopper/runs/<timestamp>-<slug>/notes.md`
- `bopper/runs/<timestamp>-<slug>/click-log.md`
- `bopper/runs/<timestamp>-<slug>/decision-log.md`
- `bopper/runs/<timestamp>-<slug>/evidence/`
- `bopper/runs/<timestamp>-<slug>/evidence/README.md`

### 4. Run output docs

These summarize the run for human review and future reuse:

- `bopper/reports/YYYY-MM-DD-<env>-<slug>.md`
- `bopper/checkpoint-summaries/YYYY-MM-DD-<env>-<slug>-summary.md`
