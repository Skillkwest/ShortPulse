...
Purpose: give Bopper a workspace-local handoff entrypoint that is easy to find from `bopper/`.
...
3. `bopper/AGENT-INSTRUCTIONS.md`
4. `bopper/MEMORY.md`
5. `bopper/PERSONA.md`
6. `bopper/TRAINING-SYSTEM.md`
7. `bopper/HANDOFF.md`
...
- coverage: `bopper/action-coverage/master-coverage-log.md`
- success map: `bopper/route-success-map.md`
- queue: `bopper/next-run-queue.md`
- first-click map: `bopper/first-click-map.md`
- confusion log: `bopper/confusion-patterns.md`
- abandonment log: `bopper/abandon-points.md`
- ignored controls: `bopper/ignored-controls-log.md`
- terminology misreads: `bopper/terminology-misread-log.md`
