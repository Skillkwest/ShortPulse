...
- `generation-pipeline-fundamental-hardening-master-plan-2026-04-26.md`: minimal repo-backed master plan for strengthening generation pipelines without intended UI, UX, or external behavior changes.
- `generation-pipeline-fundamental-hardening-tracker-2026-04-26.md`: compact tracker for the four fundamental hardening phases and the final stop gate.
- `generation-pipeline-fundamental-hardening-done-state-and-stop-rules-2026-04-26.md`: explicit done-state and stop-rule contract for the fundamental hardening program.
- `generation-pipeline-fundamental-hardening-authority-and-proof-inventory-2026-04-26.md`: authority seam and weak-proof inventory that justifies the hardening program scope.
- `generation-pipeline-fundamental-hardening-phase-1-proof-and-characterization-plan-2026-04-26.md`: Phase 1 plan for direct proof of the weak high-risk branches only.
- `generation-pipeline-fundamental-hardening-phase-2-core-server-correctness-plan-2026-04-26.md`: Phase 2 plan for fixing post-accept recoverability, `terminal_success_no_media` consistency, and `missing_generation` observation loss.
- `generation-pipeline-fundamental-hardening-phase-3-durable-media-authority-plan-2026-04-26.md`: Phase 3 plan for normalizing durable owned/generated media authority across Fal and ElevenLabs.
- `generation-pipeline-fundamental-hardening-phase-4-canonical-output-slot-convergence-plan-2026-04-26.md`: Phase 4 plan for one canonical internal output-slot convergence and repair path.
...
- `ai-studio-project-persistence-master-plan-2026-04-23.md`: canonical historical master plan for replacing legacy AI Studio session persistence with project-owned restore, project-scoped Media Library folders, and globally accessible left-rail libraries.
- `ai-studio-project-persistence-stabilization-trim-and-fix-plan-2026-04-24.md`: historical first stabilization contract for the broader Projects lane, retained for traceability after the active scope narrowed first to folder reliability and then to workspace-isolation/bootstrap.
- `ai-studio-project-folder-stabilization-trim-and-fix-plan-2026-04-24.md`: historical/deferred folder-specific stabilization contract for project folder reliability, unsaved reference persistence into folders, and safe trimming of duplicate or dormant folder-lane code.
