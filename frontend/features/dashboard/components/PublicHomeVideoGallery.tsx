...
const galleryPlaceholders: PublicHomeGalleryItem[] = [
  {
...
const galleryVideos = [...galleryPlaceholders]
...
const galleryVideoRows = galleryVideoRowSources
  .map((rowSources) =>
    rowSources
      .map((src) => galleryVideos.find((item) => item.src === src))
    ...
    <>
      <section className="public-home-gallery" aria-labelledby="public-home-gallery-heading">
        ...
        <div className="public-home-gallery-grid">
          {galleryVideoRows.map((row, rowIndex) => (
            <div
