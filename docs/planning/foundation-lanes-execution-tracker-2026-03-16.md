...
| B    | In Progress | Engineering | B4-01 active; announcements controller seam landed and users/credits characterization is locked | none                                    | Open the users/credits controller seam or explicitly rerank against `errors/events` | `docs/planning/lane-b-master-plan-2026-03-16.md`                        |
