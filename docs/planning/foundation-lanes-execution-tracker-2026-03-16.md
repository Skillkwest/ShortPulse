...
| B    | In Progress | Engineering | `B5-02` active; expert neutral surfaces, secondary controls, rail controls, collapse/mode controls, wrapper/trigger defaults, layers-toolbar cards, mode-button families, and base inpaint shell surfaces are migrated behind scoped tokens | none                                    | Choose the next bounded expert-style cluster after the base inpaint shell surfaces | `docs/planning/lane-b-master-plan-2026-03-16.md`                        |
