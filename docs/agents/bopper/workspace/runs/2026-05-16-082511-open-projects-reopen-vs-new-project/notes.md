...
- Run brief path: `docs/agents/bopper/workspace/runs/2026-05-16-082511-open-projects-reopen-vs-new-project/run-brief.md`
- Detailed report path: `docs/agents/bopper/workspace/reports/2026-05-16-local-open-projects-reopen-vs-new-project.md`
- Checkpoint summary path: `docs/agents/bopper/workspace/checkpoint-summaries/2026-05-16-local-open-projects-reopen-vs-new-project-summary.md`
