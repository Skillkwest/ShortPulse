...
7. Add a short memory entry only when the run changes Maya's future behavior.
...
- Keep screenshots only when they are needed evidence for a finding, credit-spend proof, output proof, or saved-work proof.
