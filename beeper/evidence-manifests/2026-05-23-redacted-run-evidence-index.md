...
- Durable docs to use:
  - `beeper/runs/2026-05-15-084342-prod-sign-in/notes.md`
...
- Durable docs to use:
  - `beeper/runs/2026-05-15-120659-prod-core-audit/notes.md`
...
- Durable docs to use:
  - `beeper/runs/2026-05-15-125952-prod-real-user-exploratory/notes.md`
  - `beeper/checkpoint-summaries/2026-05-15-prod-real-user-exploratory-summary.md`
  - `beeper/reports/2026-05-15-real-user-interaction-audit.md`
...
- Durable docs to use:
  - `beeper/runs/2026-05-15-133047-prod-project-create-lane/notes.md`
  - `beeper/checkpoint-summaries/2026-05-15-prod-project-create-lane-summary.md`
  - `beeper/reports/2026-05-15-production-project-creation-validation.md`
...
- Durable docs to use:
  - `beeper/runs/2026-05-15-133731-prod-ai-studio-working-lane/notes.md`
...
- Sensitive material removed: user-linked request traces
- Durable docs to use:
  - `beeper/runs/2026-05-15-134930-prod-ai-studio-non-generate-lane/notes.md`
...
- Durable docs to use:
  - `beeper/runs/2026-05-15-143100-prod-logout-signin-lane/notes.md`
...
- Sensitive material removed: user-linked request traces
- Durable docs to use:
  - `beeper/runs/2026-05-15-150037-prod-open-existing-project-lane/notes.md`
  - `beeper/checkpoint-summaries/2026-05-15-prod-open-existing-project-lane-summary.md`
  - `beeper/reports/2026-05-15-production-open-existing-project-lane.md`
...
- Durable docs to use:
  - `beeper/runs/2026-05-15-153045-prod-ai-studio-deeper-non-generate-lane/notes.md`
  - `beeper/checkpoint-summaries/2026-05-15-prod-ai-studio-deeper-non-generate-lane-summary.md`
  - `beeper/reports/2026-05-15-production-ai-studio-deeper-non-generate-lane.md`
...
- Sensitive material removed: user-linked request traces
- Durable docs to use:
  - `beeper/runs/2026-05-15-160043-prod-profile-safe-edit-save-lane/notes.md`
  - `beeper/checkpoint-summaries/2026-05-15-prod-profile-safe-edit-save-lane-summary.md`
  - `beeper/reports/2026-05-15-production-profile-safe-edit-save-lane.md`
...
- Durable docs to use:
  - `beeper/runs/2026-05-15-163023-prod-media-library-search-lane/notes.md`
...
- Sensitive material removed: none beyond ordinary UI-state capture
- Durable docs to use:
  - `beeper/runs/2026-05-15-170121-prod-character-route-bundle/notes.md`
  - `beeper/checkpoint-summaries/2026-05-15-prod-character-route-bundle-summary.md`
...
- Durable docs to use:
  - `beeper/runs/2026-05-15-171728-prod-ai-studio-stateful-non-generate/notes.md`
  - `beeper/checkpoint-summaries/2026-05-15-prod-ai-studio-stateful-non-generate-summary.md`
  - `beeper/reports/2026-05-15-production-ai-studio-stateful-non-generate.md`
...
- Durable docs to use:
  - `beeper/runs/2026-05-15-231544-prod-character-reuse-lane/notes.md`
  - `beeper/checkpoint-summaries/2026-05-15-prod-character-reuse-lane-summary.md`
