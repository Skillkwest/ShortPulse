...
| P1   | In Progress | Engineering | `P0-01` baseline lock and `P1-01` shared contract gate are complete; `P2-01` allowlist completeness is next before any unknown-field enforcement | none                                    | `P2-01` contract completeness                                             | `docs/planning/generation-pipeline-hardening-master-plan-2026-03-16.md` |
