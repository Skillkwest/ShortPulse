...
Provider reference for Kling 3.0 Pro image-to-video jobs via the Fal queue (`fal-ai/kling-video/v3/pro/image-to-video`). ShortPulse no longer exposes a Fal proxy route for this model; active ShortPulse Kling generation uses the Kie Kling 3.0 lane.
