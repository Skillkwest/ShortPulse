# System Catalog Agent Reports

Purpose: store full audit packets, roadmap snapshots, dispatch tracking, and inbound execution-lane closeouts used by the System Catalog Agent.
...
- Catalog Agent-authored audit and tracking reports stay in this folder.
