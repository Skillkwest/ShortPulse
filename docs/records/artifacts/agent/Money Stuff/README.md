# Money Stuff Agent Artifacts

Purpose: store non-authoritative retained artifacts for Money Stuff's subscription, credit-package, and recurring storage/media add-on billing work.

## Status

Money Stuff is currently at `Level 1: Supervised`.

The agent has a durable contract, repo-visible memory, and an initial artifact area. Money Stuff is ready for supervised recurring billing work and future training runs.

## Artifact Layout

- `memory.md`: retained working memory that supports the repo-visible memory surface.
- `run-log.md`: append-only log of substantive Money Stuff runs.
- `sops.md`: Money Stuff workflow references and emerging SOP needs.
...
Every substantive Money Stuff run should produce retained evidence:
...
- Agent contract: `docs/agents/Money Stuff/README.md`
- Repo-visible memory: `docs/agents/Money Stuff/memory.md`
- Source-of-truth map: `docs/agents/Money Stuff/source-of-truth-map.md`
