...
const usage = () => {
  console.log(`Usage:
  node docs/agents/beeper/workspace/scripts/live-product-walkthrough.mjs [options]
...
Options:
  ...
  --output-dir <path>      Optional output directory. Defaults to docs/agents/beeper/workspace/evidence-cache/<timestamp>.
