...
- [x] Harden CI dependency install path with transient-retry wrapper for `npm ci` across install jobs (`scripts/ci_npm_ci_with_retry.sh`, `docs/planning/evidence/agent/phase-4/2026-02-21-phase-4-npm-ci-transient-retry-hardening.md`, validated by runs `22259261557` and `22259338790`).
