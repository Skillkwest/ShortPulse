...
| --- | --- | --- |
| Auth | Production sign-in works with the audit account. | `beeper/checkpoint-summaries/2026-05-15-prod-sign-in-summary.md` |
| Logout / login return | Full logout -> sign-back-in loop works when the confirmation step is completed. | `beeper/checkpoint-summaries/2026-05-15-prod-logout-signin-lane-summary.md` |
| Dashboard -> project create | Project creation works and the created project persists. | `beeper/checkpoint-summaries/2026-05-15-prod-project-create-lane-summary.md` |
| Dashboard -> open existing project | Opening an existing project from the dashboard overlay works and survives reload. | `beeper/checkpoint-summaries/2026-05-15-prod-open-existing-project-lane-summary.md` |
| AI Studio persistence | Prompt edits on a saved project persist after reload and after a fresh signed-in reopen. | `beeper/checkpoint-summaries/2026-05-15-prod-ai-studio-stateful-non-generate-summary.md` |
| AI Studio deeper non-generate action | Media Library audio playback worked during a deeper non-generate lane. | `beeper/checkpoint-summaries/2026-05-15-prod-ai-studio-deeper-non-generate-lane-summary.md` |
| Profile settings | Account display-name edit/save/reload flow worked. | `beeper/checkpoint-summaries/2026-05-15-prod-profile-safe-edit-save-lane-summary.md` |
| Media Library browse/select | Normal browse and select behavior mostly worked, including `Deselect all`. | `beeper/checkpoint-summaries/2026-05-15-prod-media-library-search-lane-summary.md` |
| Character in-session edit path | Existing-character rename worked in-session and `Add character look` worked in-session. | `beeper/checkpoint-summaries/2026-05-15-prod-character-route-bundle-summary.md` |
