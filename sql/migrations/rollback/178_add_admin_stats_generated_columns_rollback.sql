-- Roll back migration 178 by restoring the migration-177 admin global stats
-- RPC body, then dropping the generated scalar projections added for admin
-- stats I/O reduction.
...
alter table public.generation_projection
    drop column if exists admin_stats_has_reference_inputs,
    drop column if exists admin_stats_character_mode_applied,
    drop column if exists admin_stats_style_applied;

alter table public.ai_generations
    drop column if exists admin_stats_autosave_decision;
