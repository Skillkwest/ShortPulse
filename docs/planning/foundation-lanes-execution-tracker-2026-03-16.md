...
| P1   | In Progress | Engineering | `P0-01` through `P4-01` are complete; queue claim collisions are now reduced at the SQL source and bounded at runtime, with `P5-01` ADR/SOP closeout next | none                                    | `P5-01` docs/ADR closeout                                                 | `docs/planning/generation-pipeline-hardening-master-plan-2026-03-16.md` |
