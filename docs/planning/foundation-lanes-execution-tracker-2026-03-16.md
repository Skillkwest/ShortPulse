...
| D    | In Progress | Engineering | `D1-01` is complete; `D1-02` is next on `useAiStudioAgentBridge` runtime reset hardening                                               | Remaining strict-runtime debt in `DetailModal` and `useAiStudioAgentBridge`; full-suite baseline is still red on unrelated admin ledger assertion | `D1-02` agent-bridge reset hardening                                      | `docs/planning/lane-d-master-plan-2026-03-16.md`                        |
