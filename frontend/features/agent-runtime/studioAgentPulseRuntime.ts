...
export const buildStudioAgentPulseSystemMessage = (
  ...
  if (pulseKind === "custom_gpt") {
    return [
      ...
      "Ordinary user-facing replies should stay structured and readable, but any final prompt or direct prompt artifact must be returned as one plain text block paragraph with no bullets, headings, or outline formatting.",
