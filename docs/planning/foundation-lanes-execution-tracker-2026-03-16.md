...
| B | In Progress | Engineering | B2-02 active; characterization lock plus geometry/overlay helper splits have brought `useInpaintMaskController.ts` below the warn budget | none | Run a B2-02 checkpoint review before deciding whether to stop or open the next orchestration slice | `docs/planning/lane-b-master-plan-2026-03-16.md` |
