/**
 * Server implementation for authenticated Media Library URL copy persistence.
...
import { parseInternalMediaRefFromSupabaseSignedUrl } from "../media/internalMediaRefs";
import { withCanonicalImageDimensions } from "../mediaDimensionMetadata";
import { resolvePreviewStoragePath } from "../mediaPreviewPath";
import { resolveMediaRowKind, type MediaRowKindInput } from "../mediaRowKind";
import {
...
import { admitImageBufferForProductUse, type ImageAdmissionAcceptedResult } from "./imageAdmission";
import {
...
import {
  ...
  asRecord,
  fetchPosterSource,
  fetchUrlWithRedirectValidation,
  normalizeOwnedStoragePathHint,
  normalizePosterSourceUrl,
  parseFileTypeHint,
  parseIndex,
  parseMode,
  parseRequestBody,
  parseSource,
  parseUrlFromRequest,
  sanitizePreviewUrlHint,
  toSafeUserScopedPath,
  validateTrustedGeneratedMediaUrl,
  validateTrustedUrl,
  type UrlTrustValidator,
} from "./mediaCopyFromUrlFetch";
