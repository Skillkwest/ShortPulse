...
export const DEFAULT_REFERENCE_GRID_ACTIVE_LIMIT = 500;
export const DEFAULT_ARCHIVE_PREVIEW_KEEP_COUNT = 120;
export const REFERENCE_GRID_FLAG_SOFT_ARCHIVE =
  process.env.NEXT_PUBLIC_REFERENCE_GRID_SOFT_ARCHIVE !== "false";
export const REFERENCE_GRID_ACTIVE_LIMIT = Number(
  process.env.NEXT_PUBLIC_REFERENCE_GRID_ACTIVE_LIMIT ?? DEFAULT_REFERENCE_GRID_ACTIVE_LIMIT
);
export const REFERENCE_GRID_ARCHIVE_PREVIEW_KEEP_COUNT = Number(
