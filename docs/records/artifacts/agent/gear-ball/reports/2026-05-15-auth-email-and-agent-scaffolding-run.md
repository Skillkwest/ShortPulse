...
| `7013b198a` | agent scaffolding    | `docs/agents/ayla/workspace/`, `docs/agents/beeper/workspace/`, agent contracts, retained artifacts  | low    | `gear-ball:preflight`, `docs:check`                                                                        |
