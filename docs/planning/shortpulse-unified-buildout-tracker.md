...
| 04 | In Progress | Engineering | Phase 03 complete | Video runtime residual hardening validated | `evidence/unified-buildout/phase-04/` | Slice A/B in progress: trusted Fal outbound URL policy enforcement in submit/status/recovery paths |
