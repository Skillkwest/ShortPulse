...
| B    | In Progress | Engineering | `B5-02` active; expert neutral surfaces, secondary controls, rail controls, collapse/mode controls, wrapper/trigger defaults, layers-toolbar cards, and mode-button families are migrated behind scoped tokens | none                                    | Choose the next bounded expert-style cluster after the mode-button family | `docs/planning/lane-b-master-plan-2026-03-16.md`                        |
