...
2. `docs/records/artifacts/agent-pipeline-remediation/phase-3/artifacts/2026-03-20/phase-3-staging-canary-input-template.json`
3. `docs/records/artifacts/agent-pipeline-remediation/phase-3/artifacts/2026-03-20/phase-3-staging-canary-delta-packet-template-output.md`
...
## Validation
Commands executed:
1. `node scripts/generate_phase3_canary_delta_packet.mjs --input docs/records/artifacts/agent-pipeline-remediation/phase-3/artifacts/2026-03-20/phase-3-staging-canary-input-template.json --out docs/records/artifacts/agent-pipeline-remediation/phase-3/artifacts/2026-03-20/phase-3-staging-canary-delta-packet-template-output.md`
