...
- Local instructions: `docs/agents/bopper/workspace/AGENT-INSTRUCTIONS.md`
- Local memory: `docs/agents/bopper/workspace/MEMORY.md`
...
- `docs/agents/bopper/workspace/` is the working lane for average-user artifacts, not the retained source of truth.
