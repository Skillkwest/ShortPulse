...
- Beeper's workspace should stay segregated from Bopper's by default. Do not copy Bopper notes, summaries, or confusion artifacts into `beeper/` unless the user explicitly asks for a comparative synthesis.
