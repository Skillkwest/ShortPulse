-- Fix 029 runtime ambiguity in upsert_ai_agent_conversation_state ON CONFLICT target.
-- Keeps function signature/contract unchanged.
...
begin
    ...
    on conflict on constraint ai_agent_conversation_state_pkey do update
