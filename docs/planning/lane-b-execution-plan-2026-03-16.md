...
| `B3-02` | B-Core | `useCharacterManagerDraft.ts` | Split draft-state orchestration into feature slices while preserving caller contract | `docs/planning/evidence/lane-b/2026-03-17-b3-02-character-draft-asset-controller-split.md` | In Progress |
