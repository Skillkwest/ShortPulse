...
2. Check `docs/agents/beeper/workspace/action-coverage/master-coverage-log.md` and pick a lane that expands coverage instead of repeating the last shallow pass.
