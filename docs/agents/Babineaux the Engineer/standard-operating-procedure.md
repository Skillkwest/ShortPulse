...
Use this mode during a defined launch or launch-week operations window. The current ShortPulse posture is launch-week production operations following the `2026-07-07` launch.
