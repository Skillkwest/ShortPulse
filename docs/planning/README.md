...
- `mini-ecosystem/README.md`: sequestered mini-project that defines a practical, real-company delivery model (flow, handoffs, and quality gates).
- `mini-ecosystem/in-practice-flow.md`: seven-step delivery lifecycle from ticket definition through post-release learning.
- `mini-ecosystem/roles-and-handoffs.md`: role responsibilities, entry/exit handoff criteria, and common failure patterns.
- `mini-ecosystem/artifacts-and-gates.md`: minimum artifacts, pass/fail quality gates, and maturity rubric for delivery process adoption.
- `mini-ecosystem/mini-production-sop.md`: governing solo multi-role SOP with lifecycle gates (`A-E`), escalation, and hat-switching protocol.
- `mini-ecosystem/handbook.md`: practical operator handbook for day-to-day use of the mini ecosystem and templates.
- `mini-ecosystem/quick-start-cheat-sheet.md`: 5-minute operator cheat sheet for feature and weekly audit execution.
- `mini-ecosystem/workflow-feature-delivery.md`: checklist-first feature lifecycle execution flow (`request -> release -> feedback`).
- `mini-ecosystem/workflow-codebase-audit.md`: recurring role-based audit workflow for current codebase quality and remediation planning.
- `mini-ecosystem/decision-precedence.md`: conflict-resolution hierarchy for multi-role decision collisions.
- `mini-ecosystem/definition-of-done.md`: global done contract applied across feature and audit workflows.
- `mini-ecosystem/cadence-and-rituals.md`: recurring operating rhythms (kickoff, pre-merge gate review, observation window, weekly audit).
