...
## Artifacts
Local:
1. `docs/records/artifacts/agent-pipeline-remediation/phase-2/artifacts/2026-03-20/local-safety-sim-summary.json`
2. `docs/records/artifacts/agent-pipeline-remediation/phase-2/artifacts/2026-03-20/local-safety-sim-aggregates.json`
