...
- Video policy invariant:
  ...
  - `kie-ai/seedance-1.5-pro` is a deprecated compatibility lane that now restores to `kie-ai/seedance-2`.
...
| kie-ai/seedance-1.5-pro                         | Aspect: 1:1 default (allowed: 1:1, 21:9, 4:3, 3:4, 16:9, 9:16); Duration: 4s default (allowed: 4, 8, 12); Resolution: 720p default (allowed: 480p, 720p, 1080p); Audio: off; Fixed lens: off                                                                 | Deprecated compatibility lane retained for persisted-state/runtime continuity. New picker selection should use `kie-ai/seedance-2`; restore now normalizes old 1.5 saves onto Seedance 2 through catalog replacement metadata.                                                                                                                                                                                                                                      |
