...
| P1   | In Progress | Engineering | `P0-01` through `P3-02` are complete; submit and dispatch now fail closed on contract violations, with `P3-03` identity invariants next | none                                    | `P3-03` identity invariant lock                                           | `docs/planning/generation-pipeline-hardening-master-plan-2026-03-16.md` |
