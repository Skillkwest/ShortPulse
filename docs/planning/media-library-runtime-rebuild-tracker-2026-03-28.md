...
| `MLR-0-S2` | `MLR-0` | Capture characterization inventory, freeze repro matrix, and cutover thresholds | Planned | baseline packet linked before closeout and freeze-signoff | docs check | no code-path change | Pending |
