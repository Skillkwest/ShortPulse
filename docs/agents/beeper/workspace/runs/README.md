...
- Raw screenshots, JSON packets, storage-state dumps, and other sensitive artifacts should live in the ignored local cache at `docs/agents/beeper/workspace/evidence-cache/`, not inside tracked run packets.
- Historical raw `evidence/` folders were retired from tracked workspace storage on `2026-05-23`; use `docs/agents/beeper/workspace/evidence-manifests/2026-05-23-redacted-run-evidence-index.md` when an older report references them.
