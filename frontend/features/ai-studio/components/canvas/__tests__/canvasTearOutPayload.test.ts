...
describe("buildCanvasTearOutPayload", () => {
  ...
  it("exports video and audio items for media-slot tear-out", () => {
    ...
    const audioPayload = buildCanvasTearOutPayload({
      ...
      title: "Quiet Signal",
      companionArtUrl: "https://cdn.shortpulse.test/audio-cover.webp",
      companionArtStoragePath: "user-1/audio/canvas/audio-cover.webp",
      width: 160,
      height: 220,
      durationMs: 9000,
    ...
    expect(audioPayload).toMatchObject({
      ...
      internalPayload: {
        ...
        referenceRenderUrl: "https://cdn.shortpulse.test/audio-cover.webp",
