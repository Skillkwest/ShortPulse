...
- Custom Pulse authoring now centers on `Preset Name` and `System Instructions`; advanced runtime controls are not exposed in preset editors, and newly created custom Pulses default to GPT-style start-immediately guided behavior.
