...
| P1   | In Progress | Engineering | `P0-01`, `P1-01`, and `P2-01` are complete; shared contract coverage is locked and `P3-01` submit hardening is next | none                                    | `P3-01` submit hardening                                                  | `docs/planning/generation-pipeline-hardening-master-plan-2026-03-16.md` |
