...
Purpose: store future full run reports for significant average-user walkthroughs, confusion audits, and abandonment investigations.
...
- Every substantive report should preserve:
  - interaction fidelity
  - first click
  - confusion or abandonment signal
  - route success target
  - score and next-run drill
