> Archived 2026-06-01 during planning cleanup. Reason: documentation-only reference packet for a paused rebuild against the retired `/api/ai/sessions/*` lane; retained as historical context, not active planning authority.
...
```json
{
  ...
  "outputs": {
    "active": [
      /* reference-safe output projection */
    ],
    "archived": [
      /* reference-safe output projection */
    ],
