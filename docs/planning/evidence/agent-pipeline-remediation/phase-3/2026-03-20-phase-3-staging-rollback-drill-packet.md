...
2. `docs/planning/evidence/agent-pipeline-remediation/phase-3/artifacts/2026-03-20/rollback-drill/phase-3-staging-rollback-drill-preflight.json`
3. `docs/planning/evidence/agent-pipeline-remediation/phase-3/artifacts/2026-03-20/rollback-drill/phase-3-staging-rollback-drill-execution.json`
...
## Validation
Commands executed:
1. `node scripts/run_phase3_staging_rollback_drill.mjs --out docs/planning/evidence/agent-pipeline-remediation/phase-3/artifacts/2026-03-20/rollback-drill/phase-3-staging-rollback-drill-preflight.json`
2. `node scripts/run_phase3_staging_rollback_drill.mjs --execute-rollback --reason phase3_staging_rollback_drill_execution --source phase3_ops --cooldown-hours 1 --out docs/planning/evidence/agent-pipeline-remediation/phase-3/artifacts/2026-03-20/rollback-drill/phase-3-staging-rollback-drill-execution.json`
