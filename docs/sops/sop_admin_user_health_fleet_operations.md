...
- Admin/operator access to:
  - Customer Support -> `Fleet health` (`/admin/user-health-fleet`)
  - Customer Support -> `User health` (`/admin/user-health`)
  - Customer Support -> `Generation trace` (`/admin/generation-trace`)
