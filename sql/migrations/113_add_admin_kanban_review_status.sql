-- Add Review as an admin kanban status between In progress and Complete.
-- Keeps the UI workflow, table constraints, activity constraints, and move RPC aligned.
