...
const MEDIA_LIBRARY_FALLBACK_DISPLAY_TITLE_TYPE = "text/shortpulse-media-library-display-title";
  ...
  if (kind === "libraryMedia") {
    ...
    return {
      ...
      payload: {
        ...
        displayTitle: normalizeTransferText(
          transfer.getData(MEDIA_LIBRARY_FALLBACK_DISPLAY_TITLE_TYPE)
        ),
        promptText:
        ...
        sourceRef: normalizeTransferText(transfer.getData(MEDIA_LIBRARY_FALLBACK_SOURCE_REF_TYPE)),
...
export const writeMediaLibraryDragPayload = (
  ...
  if (payload.kind === "libraryMedia") {
    ...
    setTransferTextIfPresent(
      transfer,
      MEDIA_LIBRARY_FALLBACK_DISPLAY_TITLE_TYPE,
    ...
    setTransferTextIfPresent(
      transfer,
      MEDIA_LIBRARY_FALLBACK_SOURCE_REF_TYPE,
      payload.payload.sourceRef
    );
    setTransferTextIfPresent(
      transfer,
