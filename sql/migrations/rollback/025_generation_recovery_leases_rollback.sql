-- Rollback: restore 3-parameter claim_generation_recovery_batch function semantics.

drop function if exists public.claim_generation_recovery_batch(integer, integer, integer, integer);
