...
| B | In Progress | Engineering | B2-02 active; B2-01 stop review complete, `ExpertEditPanelView.tsx` checkpointed below warn budget, and inpaint controller hotspot mapping now points to characterization-first extraction | none | Open B2-02 with behavior characterization and first pure-helper split | `docs/planning/lane-b-master-plan-2026-03-16.md` |
