drop function if exists public.claim_generation_submit_queue_batch(integer, integer, uuid);
...
begin
    ...
    select
        ...
        c.user_id,
        c.model_id,
        g.provider as generation_provider,
        g.request_id as generation_request_id,
        coalesce(g.metadata, '{}'::jsonb) as generation_metadata,
        c.source_ref,
        c.submit_route,
        c.submit_payload,
        c.timeout_ms,
