...
| B    | In Progress | Engineering | `B5-02` active; expert neutral surfaces, secondary controls, and rail controls are now migrated behind scoped tokens                    | none                                    | Choose the next bounded expert-style cluster after rail controls          | `docs/planning/lane-b-master-plan-2026-03-16.md`                        |
