...
- The score bump is justified if the Catalog Agent agrees the most drift-prone direct-vs-queued ingress ambiguity is now explicit, fail-closed, and regression-tested.
