          ...
          builtInDefinitions: [
            {
              ...
              systemInstructions: "Follow the catalog instructions.",
          ...
          builtInDefinitions: [
            {
              ...
              systemInstructions: "Ask for the source prompt, then improve it.",
              runtimeMode: "workflow_gpt",
              activationMode: "activate_and_start",
          ...
          builtInDefinitions: [
            {
              ...
              label: "Catalog Test",
              description: "Server catalog entry.",
              systemInstructions: "Follow the refreshed catalog instructions.",
              runtimeMode: "workflow_gpt",
              activationMode: "activate_and_start",
              outputMode: "chat_reply",
              memoryPolicy: "session",
          ...
          builtInDefinitions: [
            {
              ...
              systemInstructions: "Follow the seed fallback instructions.",
              runtimeMode: "workflow_gpt",
              activationMode: "activate_and_start",
              outputMode: "chat_reply",
              memoryPolicy: "session",
