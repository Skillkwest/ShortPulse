...
exports.listModelConfigs = exports.getModelConfig = void 0;
var modelSizes_1 = require("./modelSizes");
var providerModelIds_1 = require("./providerModelIds");
var modelApiContracts_1 = require("./modelApiContracts");
var contractDefaultAspect = function (modelId, fallback) {
    return (0, modelApiContracts_1.getModelDefaultAspect)(modelId, fallback);
};
var contractAllowedAspects = function (modelId, fallback) {
    return (0, modelApiContracts_1.getModelAllowedAspects)(modelId, fallback);
};
var contractDefaultResolution = function (modelId, fallback) { return (0, modelApiContracts_1.getModelDefaultResolution)(modelId, fallback); };
var contractAllowedResolutions = function (modelId, fallback) { return (0, modelApiContracts_1.getModelAllowedResolutions)(modelId, fallback); };
var contractDefaultDuration = function (modelId, fallback) { return (0, modelApiContracts_1.getModelDefaultDurationSeconds)(modelId, fallback); };
var contractAllowedDurations = function (modelId, fallback) { return (0, modelApiContracts_1.getModelAllowedDurations)(modelId, fallback); };
var registry = (_a = {
        "fal-ai/flux-2/klein/9b": {
            ...
            sizeMap: modelSizes_1.falImageSizeMap,
        ...
        "fal-ai/bytedance/seedream/v4.5/text-to-image": {
            ...
            defaultResolution: contractDefaultResolution("fal-ai/bytedance/seedream/v4.5/text-to-image", "auto_2K"),
        ...
        "fal-ai/bytedance/seedream/v5/lite/text-to-image": {
            ...
            defaultResolution: contractDefaultResolution("fal-ai/bytedance/seedream/v5/lite/text-to-image", "auto_2K"),
            allowedResolutions: contractAllowedResolutions("fal-ai/bytedance/seedream/v5/lite/text-to-image", ["auto_2K", "auto_3K"]),
            supportsTextToImage: true,
        },
        "fal-ai/bytedance/seedream/v5/lite/edit": {
            ...
            pricingStrategy: "seedream-5-lite-per-image",
            defaultResolution: contractDefaultResolution("fal-ai/bytedance/seedream/v5/lite/edit", "auto_2K"),
        ...
        "fal-ai/kling-video/v3/pro/text-to-video": {
            ...
            defaultAudio: true,
            allowedDurations: contractAllowedDurations("fal-ai/kling-video/v3/pro/text-to-video", [5, 6, 7, 8, 9, 10]),
        },
        "fal-ai/kling-video/v3/pro/image-to-video": {
            ...
            defaultResolution: contractDefaultResolution("fal-ai/kling-video/v3/pro/image-to-video", "1080p"),
            defaultAudio: true,
            allowedResolutions: contractAllowedResolutions("fal-ai/kling-video/v3/pro/image-to-video", [
                "720p",
                "1080p",
            ]),
            allowedDurations: contractAllowedDurations("fal-ai/kling-video/v3/pro/image-to-video", [5, 6, 7, 8, 9, 10]),
        ...
        "fal-ai/veo3.1/first-last-frame-to-video": {
            ...
            allowedDurations: contractAllowedDurations("fal-ai/veo3.1/first-last-frame-to-video", [4, 6, 8]),
        },
        ...
        "fal-ai/bytedance/seedance/v1.5/pro/text-to-video": {
            ...
            provider: "fal",
            mediaType: "video",
            defaultAspect: contractDefaultAspect("fal-ai/bytedance/seedance/v1.5/pro/text-to-video", "16:9"),
            ...
            defaultDurationSeconds: contractDefaultDuration("fal-ai/bytedance/seedance/v1.5/pro/text-to-video", 10),
            defaultResolution: contractDefaultResolution("fal-ai/bytedance/seedance/v1.5/pro/text-to-video", "1080p"),
            defaultAudio: true,
            allowedResolutions: contractAllowedResolutions("fal-ai/bytedance/seedance/v1.5/pro/text-to-video", ["480p", "720p", "1080p"]),
            allowedDurations: contractAllowedDurations("fal-ai/bytedance/seedance/v1.5/pro/text-to-video", [4, 5, 6, 7, 8, 9, 10, 11, 12]),
        },
        "fal-ai/bytedance/seedance/v1.5/pro/image-to-video": {
            ...
            provider: "fal",
            mediaType: "image-to-video",
            defaultAspect: contractDefaultAspect("fal-ai/bytedance/seedance/v1.5/pro/image-to-video", "16:9"),
            ...
            pricingStrategy: "seedance-1.5-per-second",
            defaultDurationSeconds: contractDefaultDuration("fal-ai/bytedance/seedance/v1.5/pro/image-to-video", 5),
            minDurationSeconds: 4,
            maxDurationSeconds: 12,
            defaultResolution: contractDefaultResolution("fal-ai/bytedance/seedance/v1.5/pro/image-to-video", "1080p"),
            defaultAudio: true,
            allowedResolutions: contractAllowedResolutions("fal-ai/bytedance/seedance/v1.5/pro/image-to-video", ["480p", "720p", "1080p"]),
            allowedDurations: contractAllowedDurations("fal-ai/bytedance/seedance/v1.5/pro/image-to-video", [4, 5, 6, 7, 8, 9, 10, 11, 12]),
            supportsImageToVideo: true,
        }
    },
    _a[providerModelIds_1.KIE_VEO_31_FAST_I2V_MODEL_ID] = {
        id: providerModelIds_1.KIE_VEO_31_FAST_I2V_MODEL_ID,
        label: "Veo 3.1 Fast I2V (Kie)",
        provider: "kie",
        mediaType: "image-to-video",
        defaultAspect: contractDefaultAspect(providerModelIds_1.KIE_VEO_31_FAST_I2V_MODEL_ID, "16:9"),
        allowedAspects: contractAllowedAspects(providerModelIds_1.KIE_VEO_31_FAST_I2V_MODEL_ID, ["16:9", "9:16"]),
        pricingStrategy: "veo-3-per-second",
        defaultDurationSeconds: contractDefaultDuration(providerModelIds_1.KIE_VEO_31_FAST_I2V_MODEL_ID, 5),
        minDurationSeconds: 5,
        maxDurationSeconds: 8,
        defaultResolution: contractDefaultResolution(providerModelIds_1.KIE_VEO_31_FAST_I2V_MODEL_ID, "720p"),
        defaultAudio: true,
        allowedResolutions: contractAllowedResolutions(providerModelIds_1.KIE_VEO_31_FAST_I2V_MODEL_ID, ["720p", "1080p"]),
        allowedDurations: contractAllowedDurations(providerModelIds_1.KIE_VEO_31_FAST_I2V_MODEL_ID, [5, 8]),
        supportsImageToVideo: true,
    },
    _a[providerModelIds_1.KIE_KLING_30_MODEL_ID] = {
        id: providerModelIds_1.KIE_KLING_30_MODEL_ID,
        label: "Kling 3.0 (Kie)",
        provider: "kie",
        mediaType: "image-to-video",
        defaultAspect: contractDefaultAspect(providerModelIds_1.KIE_KLING_30_MODEL_ID, "16:9"),
        allowedAspects: contractAllowedAspects(providerModelIds_1.KIE_KLING_30_MODEL_ID, ["16:9", "9:16", "1:1"]),
        pricingStrategy: "kling-3-per-second",
        defaultDurationSeconds: contractDefaultDuration(providerModelIds_1.KIE_KLING_30_MODEL_ID, 10),
        minDurationSeconds: 5,
        maxDurationSeconds: 10,
        defaultResolution: contractDefaultResolution(providerModelIds_1.KIE_KLING_30_MODEL_ID, "1080p"),
        defaultAudio: true,
        allowedResolutions: contractAllowedResolutions(providerModelIds_1.KIE_KLING_30_MODEL_ID, ["720p", "1080p"]),
        allowedDurations: contractAllowedDurations(providerModelIds_1.KIE_KLING_30_MODEL_ID, [5, 10]),
        supportsImageToVideo: true,
    },
    _a["gpt-5-nano"] = {
        id: "gpt-5-nano",
    ...
    _a);
var getModelConfig = function (id) { var _a; return (_a = registry[id]) !== null && _a !== void 0 ? _a : null; };
exports.getModelConfig = getModelConfig;
var listModelConfigs = function () { return Object.values(registry); };
exports.listModelConfigs = listModelConfigs;
