...
| Drop external text                 | Plain/prompt text drop                                      | Inserts a text canvas item with its top-left corner anchored at the exact cursor release point, including matching loading placeholder flow |
