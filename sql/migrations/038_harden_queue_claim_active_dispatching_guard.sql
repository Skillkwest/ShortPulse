-- Queue claim hardening: avoid claiming queued rows for users that already have
-- an active, unexpired dispatching lease. This prevents unique-index conflicts
-- on ux_ai_generation_submit_queue_dispatching_user during queue-status kick dispatch.
