...
| P1   | In Progress | Engineering | `P0-01` through `P3-03` are complete; submit, dispatch, and queue identity invariants now fail closed deterministically, with `P4-01` claim-collision remediation next | none                                    | `P4-01` claim-collision remediation                                       | `docs/planning/generation-pipeline-hardening-master-plan-2026-03-16.md` |
...
- [x] Capture baseline outputs for `docs:check` and scoped validation commands.
- [x] Wire Lane E artifacts in roadmap/tracker/docs indexes.
- [x] Freeze Lane E non-goals and rollback posture.
...
- [x] Resolve ADR inventory integrity drift (including duplicate-number handling).
