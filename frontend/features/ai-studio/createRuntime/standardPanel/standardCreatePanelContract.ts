...
export const buildStandardCreatePanelProps = ({
  ...
  return {
    ...
    assistantBubbleMedia,
    stagedAttachments: chatModeEnabled ? agentAttachments : [],
    agentDropActive: chatModeEnabled && isAgentDropActive,
    onAgentInputChange: handleAgentInputChange,
    onChatModeEnabledChange: setChatModeEnabled,
    onAgentSend: handleAgentSend,
    onAgentAttachmentDrop: chatModeEnabled ? handleAgentAttachmentDrop : undefined,
    onAgentAttachmentDragOver: chatModeEnabled ? handleAgentAttachmentDragOver : undefined,
    onAgentAttachmentDragEnter: chatModeEnabled ? handleAgentAttachmentDragEnter : undefined,
    onAgentAttachmentDragLeave: chatModeEnabled ? handleAgentAttachmentDragLeave : undefined,
    onAgentComposerDirectDrop: chatModeEnabled ? handleAgentComposerDirectDrop : undefined,
