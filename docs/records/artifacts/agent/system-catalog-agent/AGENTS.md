# AGENTS.md - System Catalog Agent Artifacts

Scope: `docs/records/artifacts/agent/system-catalog-agent/`
...
- Keep current truth in the canonical docs under `docs/agents/system-catalog-agent/` and `docs/systems/`.
