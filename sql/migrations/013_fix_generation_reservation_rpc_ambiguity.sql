-- Fix ambiguous column references in generation reservation RPCs.
-- Some environments can throw "column reference \"source_ref\" is ambiguous"
-- because RETURNS TABLE output params share names with table columns.
