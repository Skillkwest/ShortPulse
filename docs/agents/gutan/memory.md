...
- Elements Manager profile image saves now use `/api/media/admit-image-asset`; Elements reference slots continue through the canonical AI Studio staged reference-image upload path.
