...
- Optional agent/runtime toggles:
  ...
  - `NEXT_PUBLIC_SHORTPULSE_PUBLIC_SIGNUP_ENABLED` (defaults open; set to `false` only for an emergency app-level signup close after confirming the intended Supabase provider posture)
