...
| B    | In Progress | Engineering | B4-01 active; Admin dashboard hotspot map is open after B3-02 checkpoint | none                                    | Open the first B4-01 controller seam from the admin hotspot map | `docs/planning/lane-b-master-plan-2026-03-16.md`                        |
