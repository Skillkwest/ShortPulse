...
- Image tool uses a two-step **Reference** flow: carded steps with numbered badges (Drop Image at 4:5, Drop prompt) plus persistent Save/Regenerate actions; first generated assets auto-seed empty drop zones, and external image files can be dragged into the Reference Canvas.
