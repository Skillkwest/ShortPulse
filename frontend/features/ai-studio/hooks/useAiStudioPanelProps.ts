...
import { buildPulseCreatePanelProps } from "./pulseCreateRuntime/usePulseCreatePanelProps";
import { buildStandardCreatePanelProps } from "./standardCreateRuntime/useStandardCreatePanelProps";
...
export const useAiStudioPanelProps = ({
  ...
  const propertiesCreate =
    expertCreateMode === "pulse"
      ? {
          expertCreateMode,
          pulse: buildPulseCreatePanelProps({
            pulsePrompt,
            agentEnabled,
            agentBootstrapReady,
            agentMessages,
            ...
            generationGuardrail,
            handleClearAgentChat,
            handlePulseCreatePrimarySubmit: pulseCreateCommands.handleGenerateArtifact,
            savePromptReference,
      ...
      : {
          expertCreateMode,
          standard: buildStandardCreatePanelProps({
            mode,
            aspect,
            model,
            currentModelLabel,
            ...
            handleClearAgentChat,
            useReferenceImageIndicator,
            handleStandardCreatePrimarySubmit: standardCreateCommands.handlePrimarySubmit,
            handleChatOffInlineGenerate: standardCreateCommands.handleChatOffInlineGenerate,
            savePromptReference,
            characterOptions,
            selectedCharacterId,
            selectedCharacterLookId,
            ...
            imageResolution,
            setImageResolution,
            beginnerCreateMode: beginnerPolicy.create.beginnerMode,
            expertCreateUiEligible: beginnerPolicy.create.expertCreateEligible,
          }),
        };
