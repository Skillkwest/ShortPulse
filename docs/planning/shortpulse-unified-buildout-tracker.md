...
| 05 | Planned | Engineering | Phase 04 complete | Media hardening delivered with parity tests | `evidence/unified-buildout/phase-05/` | Slice A/B pre-entry prep implemented (preview trust policy + new `/api/media/upload` server path); full phase entry still gated on Phase 04 canary signoff |
