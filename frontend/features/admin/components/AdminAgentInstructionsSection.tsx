...
type BuiltInStylePreviewUploadIssueMap = Record<string, string | null>;
  ...
  return (
    <>
      ...
      <div className={styles.agentInstructionWorkspace}>
        {activeInstructionSection === "standard" ? (
          <div
        ...
        {activeInstructionSection === "styles" ? (
          <div id="admin-agent-instructions-styles" className={styles.agentInstructionSectionGroup}>
            <article className={styles.agentInstructionCard}>
              ...
              >
                <label
                  className={styles.agentInstructionLabel}
                  htmlFor="admin-style-extract-prompt"
                >
                  Runtime system prompt
                </label>
                <textarea
                  ...
                  {builtInStyleDrafts.map((draft, index) => {
                    ...
                    return (
                      <article
                        ...
                        onDragOver={(event) =>
                          handleBuiltInStyleDraftDragOver(event, draft.localId)
                        }
        ...
        {activeInstructionSection === "presets" ? (
          <div
        ...
        {activeInstructionSection === "pulses" ? (
          <div id="admin-agent-instructions-pulses" className={styles.agentInstructionSectionGroup}>
            <div
            ...
            >
              <div className={styles.agentInstructionModeHeader}>
                ...
                {pulseSaveIssue || pulseCatalogLoadIssue ? (
                  <p className={styles.agentInstructionNote}>
                    {pulseSaveIssue ?? pulseCatalogLoadIssue}
                  </p>
                ) : null}
              ...
              {pulseSectionCollapsed ? (
                <p className={styles.agentInstructionCollapsedSummary}>
                  {pulseDrafts.length} built-in Pulse slot{pulseDrafts.length === 1 ? "" : "s"}{" "}
                  ready to expand and edit.
                </p>
              ) : null}
            </div>
          </div>
