...
| B    | In Progress | Engineering | `B5-01` active; runtime panel authority, scoped migration surfaces, and the first edit-theme alias contract are now locked              | none                                    | Choose the first `ai-studio-edit-expert.css` migration slice for `B5-02` | `docs/planning/lane-b-master-plan-2026-03-16.md`                        |
