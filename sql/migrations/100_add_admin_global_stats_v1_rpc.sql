-- Add the admin global stats v1 RPC so /api/admin/stats/global can serve
-- overview, models, workflows, assets, and project analytics from one
-- service-role-only aggregate function.
