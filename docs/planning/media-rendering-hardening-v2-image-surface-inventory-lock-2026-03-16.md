...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| IMG-HOT-001 | retired-standalone-media-library-page | retired standalone Media Library page image grid | `img` | historical hot-path | Engineering | signed storage, trusted direct | signed URLs historically bypassed adaptive transform path | retired page preview profile | historical route grid tests | Historical predecessor only |
