...
| Drop external text                 | Plain/prompt text drop                                      | Inserts text canvas item with its top-left corner at the cursor release point, including loading placeholder flow |
