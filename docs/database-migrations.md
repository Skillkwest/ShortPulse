...
- Migration `153_add_dashboard_tutorials.sql` adds the admin-managed `dashboard_tutorials` table for signed-in dashboard tutorial cards with active ordered reads, service-role writes, HTTPS thumbnail metadata, and no Supabase image transformations.
