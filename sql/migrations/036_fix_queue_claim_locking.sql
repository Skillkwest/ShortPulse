-- Fix queue claim RPC to avoid window functions with FOR UPDATE SKIP LOCKED.
-- PostgreSQL rejects row_number() in locked selects; use lockable + DISTINCT ON instead.
