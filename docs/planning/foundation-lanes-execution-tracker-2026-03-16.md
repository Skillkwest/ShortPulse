...
| B    | In Progress | Engineering | `B5-02` active; expert neutral surfaces, secondary controls, rail controls, collapse/mode controls, wrapper/trigger defaults, layers-toolbar cards, mode-button families, base inpaint shell surfaces, and prompt-shell surfaces are migrated behind scoped tokens | none                                    | Run a `B5-02` stop review before taking another style slice               | `docs/planning/lane-b-master-plan-2026-03-16.md`                        |
