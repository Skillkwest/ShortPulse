...
| `B3-01` | B-Core | `CharacterManagerShell.tsx` | Extract domain hooks + shell presentation seams | `docs/planning/evidence/lane-b/2026-03-17-b3-01-character-shell-hotspot-map.md` | In Progress |
