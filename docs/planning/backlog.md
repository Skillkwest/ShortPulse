...
- Deferred post-launch UX note: quarantine or sequester Templates, Workflows, My Generations, and Community buttons so they do not compete with launch-critical creation paths or keep consuming proof/audit attention before those features are ready to build. Source: `docs/records/evidence/ux/2026-06-28-psychological-user-experience-audit.md` / "P1 - Dense AI Studio navigation includes unfinished destinations."
