...
| 15 | `Admin and launch operations` | `Launchable With Watch` | `Locally Tested` | post-deploy validation blocker cleared; final operator proof remains a watch item | Gottspan or Copperknot | `npm -C frontend run lint`, `npm -C frontend run type-check`, `npm -C frontend run docs:check`, and touched validation tests pass; authenticated operator proof remains final launch-week evidence, not the current blocker. |
