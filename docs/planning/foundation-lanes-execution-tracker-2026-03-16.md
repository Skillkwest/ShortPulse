...
| B    | In Progress | Engineering | B3-02 active; characterization lock is landed for `useCharacterManagerDraft.ts` preset orchestration and the first production split is next | none                                    | Open the first `B3-02` production split around preset orchestration       | `docs/planning/lane-b-master-plan-2026-03-16.md`                        |
