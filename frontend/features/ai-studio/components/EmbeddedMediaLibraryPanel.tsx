...
type EmbeddedMediaLibraryPanelProps = {
  surface: EmbeddedMediaLibraryPanelSurface;
  ariaLabel: string;
  errorTelemetrySource: string;
  deleteConfirmActivityId: string;
...
export function EmbeddedMediaLibraryPanel({
  surface,
  ariaLabel,
  ...
  return (
    <section
      className={joinClassNames("media-library-panel", panelClassName)}
    ...
    >
      ...
      <div className={joinClassNames("media-library-panel-content-panel", contentClassName)}>
