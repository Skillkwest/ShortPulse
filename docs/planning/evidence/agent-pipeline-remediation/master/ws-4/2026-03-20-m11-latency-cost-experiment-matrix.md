...
Source artifact:
1. `docs/planning/evidence/agent-pipeline-remediation/master/ws-4/artifacts/2026-03-20/staging-latency-cost-experiment-matrix.json`
...
node scripts/run_agent_safety_sim_matrix.mjs \
  ...
  --output-dir docs/planning/evidence/agent-pipeline-remediation/master/ws-4/artifacts/2026-03-20 \
