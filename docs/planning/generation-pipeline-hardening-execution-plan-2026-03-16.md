...
| `P3-02` | P3 | dispatch hardening | Enforce dispatch gate + deterministic fail-closed settlement | `docs/planning/evidence/generation-pipeline-hardening/2026-03-16-p3-02-dispatch-hardening.md` | Not Started |
| `P3-03` | P3 | identity invariants | Enforce queue/generation/reservation identity mismatch fail-closed path | `docs/planning/evidence/generation-pipeline-hardening/2026-03-16-p3-03-identity-invariant-lock.md` | Not Started |
| `P4-01` | P4 | queue claim collision | Harden claim RPC semantics and bounded app retry behavior | `docs/planning/evidence/generation-pipeline-hardening/2026-03-16-p4-01-claim-collision-remediation.md` | Not Started |
| `P5-01` | P5 | docs/adr closeout | Publish ADR + SOP updates and final convergence packet | `docs/planning/evidence/generation-pipeline-hardening/2026-03-16-p5-01-docs-adr-closeout.md` | Not Started |
