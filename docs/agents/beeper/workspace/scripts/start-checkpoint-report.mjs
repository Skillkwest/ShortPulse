...
/**
 * Creates a detailed Beeper checkpoint report inside docs/agents/beeper/workspace/reports/.
...
const usage = () => {
  console.log(`Usage:
  node docs/agents/beeper/workspace/scripts/start-checkpoint-report.mjs --slug <name> [options]
