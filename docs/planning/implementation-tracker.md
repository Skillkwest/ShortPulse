...
| STG-04 KEI Compatibility Decommission | Planned | @sleepyseamonster | `frontend`, `security` | N/A | replacement coverage landed | `docs/planning/evidence/kei/` | Phase C deferred until hold window |
