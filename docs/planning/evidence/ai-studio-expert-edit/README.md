...
11. `2026-03-20-cp501-canary-matrix-progress.md`
   - Phase 5 CP-501 progress packet with deterministic canary command results and browser-audit blocker evidence.
12. `2026-03-20-cp502-production-verification-scaffold.md`
   - Phase 5 CP-502 ready-to-fill production verification scaffold aligned to the same threshold/matrix contract as CP-501.
