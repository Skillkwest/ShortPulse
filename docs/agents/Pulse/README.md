...
8. Validate with targeted tests or manual smoke steps that exercise the active mode boundary.
9. Record durable lessons only when they will reduce future runtime or product drift.
