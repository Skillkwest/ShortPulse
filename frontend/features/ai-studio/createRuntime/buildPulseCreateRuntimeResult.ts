...
export const buildPulseCreateRuntimeResult = ({
  ...
  panelProps: buildPulseCreatePanelProps({
    ...
    activePulsePresetId: props.activePresetId,
    activePulsePresetLabel: props.activePresetLabel,
    activePulsePresetKind: props.activePresetKind,
    hasActivePulseSession: props.hasActiveSession,
    pulseWorkflowSession: props.workflowSession,
    ...
    handleActivePulsePresetIdChange: props.onActivePresetIdChange,
    handlePulsePresetStart: actions.onPresetStart,
