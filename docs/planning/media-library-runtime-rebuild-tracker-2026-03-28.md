...
| `MLR-3` Shared viewport engine on route and modal | Planned | route and modal observer duplication removed |
| `MLR-4` Panel cutover and folder-canvas boundary cleanup | Planned | panel browse runtime on shared substrate; folder canvas still separate |
...
| `MLR-3-S2` | `MLR-3` | Modal cutover to shared viewport and browse runtime | Planned | modal parity maintained | lint, build, targeted tests, adaptive gate if required | restore legacy modal runtime | Pending |
| `MLR-4-S1` | `MLR-4` | Panel cutover to shared browse runtime | Planned | panel parity maintained | lint, build, targeted tests, adaptive gate if required | restore legacy panel runtime | Pending |
| `MLR-4-S2` | `MLR-4` | Folder-canvas helper boundary cleanup | Planned | folder canvas remains separate from browse runtime | lint, build, targeted tests | restore prior helper boundary | Pending |
