...
- Use `docs/agents/beeper/workspace/action-coverage/master-coverage-log.md` and the performance ledger before starting.
- Use `docs/agents/beeper/workspace/route-success-map.md` before starting so the lane is tied to a believable route-level outcome.
