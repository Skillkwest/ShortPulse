...
| Fal | `fal-ai/kling-video/v2.6/pro/motion-control` | 16:9 default (allowed: 1:1, 16:9, 9:16) | Motion control queue; requires `image_url` + `video_url`; per-second pricing ($0.112/s); defaults to 10s (112 credits). |
