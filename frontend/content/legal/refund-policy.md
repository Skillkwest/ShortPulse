...
ShortPulse sells access to digital creative tools, AI generation workflows, recurring subscriptions, usage credits, storage add-ons, and related services.

Unless this Refund Policy says otherwise, payments are non-refundable once charged, credits are not redeemable for cash, and unused subscription time, unused credits, unused storage, or dissatisfaction with generated results does not automatically qualify for a refund.

We may approve refunds, account credits, service credits, credit restorations, or other adjustments at our discretion, where required by law, or where this policy says a refund or adjustment is available.
...
If you upgrade a subscription, the change may take effect immediately and may create prorated charges. If you downgrade, the change may take effect at the end of the current billing period. Refunds, prorations, or invoice credits for plan changes depend on the active Stripe configuration, applicable law, and any discretionary adjustment we approve.
...
Credits do not represent cash, stored value, gift cards, banked money, cryptocurrency, or a deposit account. Credits are not redeemable for cash, are not transferable except where we expressly allow it, and may be used only within ShortPulse.

Credit-pack purchases are generally final and non-refundable once credits are delivered to your account, except where required by law or where we approve an adjustment under this policy.

If we approve a refund for a credit pack, we may remove unused credits from that purchase. Used credits are generally not refundable.
...
If a generation fails before producing usable output because of a provider error, system error, content-policy failure, malformed provider response, or similar failed state recognized by ShortPulse's server-side billing rules, ShortPulse may release the reserved credits so you are not charged credits for that failed attempt.

If credits were captured for a generation that failed according to ShortPulse's own records, we may restore credits after review.

The following usually do not qualify for a cash refund or credit restoration:

- you dislike the creative result, quality, style, realism, composition, audio, video, image, prompt interpretation, or model behavior;
- another user or model can generate a similar or identical result;
- an output is unsuitable for your intended platform, campaign, audience, client, or commercial use;
- you provided the wrong prompt, file, reference, settings, account, billing interval, or workflow;
- you cleared, abandoned, deleted, or removed an in-flight generation placeholder in a product flow that treats the action as a no-refund abandonment;
- provider safety systems, model limits, rate limits, or policy rules affect the result but ShortPulse's billing rules treat the request as completed;
...
Storage add-on fees are generally non-refundable once charged. Removing a storage add-on stops or changes future storage add-on billing according to the active Stripe configuration. It does not automatically refund the current billing period.
...
- you were charged twice for the same purchase because of a billing error;
- a payment was unauthorized and promptly reported;
- a Stripe or ShortPulse checkout error charged you without delivering the purchased subscription access, storage add-on, or credits;
- ShortPulse records show credits were captured for a failed generation that should have released credits under our billing rules;
- we are required to provide a refund by applicable law;
- ShortPulse approves a customer-support exception in writing.

We may deny refund requests involving used credits, completed generation attempts, ordinary dissatisfaction with outputs, abandoned generation flows, account misuse, Terms violations, chargebacks, fraud, abuse, or requests made too late for us to reasonably investigate.
...
- the email address on your ShortPulse account;
- the Stripe invoice, receipt, checkout, or transaction ID if available;
- the plan, credit pack, storage add-on, or generation event at issue;
- the date and amount of the charge;
- a brief explanation of the problem;
- any screenshots or supporting details that help us investigate.

Do not send full payment-card numbers, bank-account numbers, passwords, or sensitive identity documents through ordinary support channels.

You should contact us promptly after discovering the issue. Refund and billing review requests should be submitted within 14 days after the charge or event at issue, unless applicable law gives you a longer period or the issue could not reasonably have been discovered within that period.
