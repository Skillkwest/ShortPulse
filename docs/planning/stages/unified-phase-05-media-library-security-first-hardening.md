...
5. Phase sequencing note:
   - Formal phase completion remains downstream of Phase 04 canary signoff,
   - implementation and closure prep continue under sequencing override (Decision 008).
