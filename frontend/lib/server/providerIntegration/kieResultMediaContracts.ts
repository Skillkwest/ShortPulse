  ...
  return value
    .map((item) => {
      ...
      return (
        ...
        asProviderString(row.downloadUrl) ||
        asProviderString(row.video_url) ||
        asProviderString(row.videoUrl) ||
        asProviderString(row.image_url) ||
        asProviderString(row.imageUrl) ||
        asProviderString(row.file_url) ||
        asProviderString(row.fileUrl) ||
        asProviderString(row.media_url) ||
        asProviderString(row.mediaUrl) ||
        asProviderString(row.signed_url) ||
        asProviderString(row.signedUrl) ||
        asProviderString(row.public_url) ||
        asProviderString(row.publicUrl) ||
        asProviderString(row.href)
      );
    })
...
const collectCommonCandidates = (payload: Record<string, unknown>) => {
  ...
  return [
    ...
    dataResponse.videos,
    dataResponse.outputs,
    dataResponse.artifacts,
    dataResponse.resultUrls,
    dataResponse.result_urls,
    dataResponse.image_urls,
    dataResponse.video_urls,
    dataResponseResult.images,
    dataResponseResult.videos,
    dataResponseResult.outputs,
    dataResponseResult.artifacts,
    dataResponseResult.resultUrls,
    dataResponseResult.result_urls,
    ...
    dataOutput.videos,
    dataOutput.outputs,
    dataOutput.artifacts,
    dataOutput.resultUrls,
    dataOutput.result_urls,
    dataOutput.image_urls,
    dataOutput.video_urls,
    output.images,
    output.videos,
    output.outputs,
    output.artifacts,
    ...
    resultOutput.images,
    resultOutput.videos,
    resultOutput.outputs,
    resultOutput.artifacts,
    resultOutput.resultUrls,
    resultOutput.result_urls,
    resultOutput.image_urls,
    resultOutput.video_urls,
    response.images,
    response.videos,
    response.outputs,
    response.artifacts,
    ...
    responseResult.resultUrls,
    responseResult.result_urls,
    responseResult.image_urls,
    responseResult.video_urls,
    responseData.images,
    responseData.videos,
    responseData.outputs,
    responseData.artifacts,
    responseData.resultUrls,
    ...
    rootResultJson.images,
    rootResultJson.videos,
    rootResultJson.image_urls,
    rootResultJson.video_urls,
    dataResultJson.images,
    dataResultJson.videos,
    dataResultJson.image_urls,
    dataResultJson.video_urls,
    dataResponseResultJson.images,
    dataResponseResultJson.videos,
    dataResponseResultJson.image_urls,
    dataResponseResultJson.video_urls,
    resultResultJson.images,
    resultResultJson.videos,
    resultResultJson.image_urls,
    resultResultJson.video_urls,
    outputResultJson.images,
    outputResultJson.videos,
    outputResultJson.image_urls,
    outputResultJson.video_urls,
    dataResultResultJson.images,
    dataResultResultJson.videos,
    dataResultResultJson.image_urls,
    dataResultResultJson.video_urls,
    resultDataResultJson.images,
    resultDataResultJson.videos,
    resultDataResultJson.image_urls,
    resultDataResultJson.video_urls,
    outputResultResultJson.images,
    outputResultResultJson.videos,
    outputResultResultJson.image_urls,
    outputResultResultJson.video_urls,
