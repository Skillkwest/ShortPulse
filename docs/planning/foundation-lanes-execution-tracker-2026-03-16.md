...
| F    | In Progress | Engineering | `F0-01` baseline lock and `F1-01` CI inventory/required-check parity are complete; `F2-01` plan-limited enforcement is next            | none                                    | `F2-01` plan-limited enforcement model                                    | `docs/planning/lane-f-master-plan-2026-03-16.md`                        |
