...
- Routes covered: `/dashboard`, `/ai-studio`, `/media-library`, `/character`, `/profile`
...
| 4    | media-library focused pass | Reopened `/media-library`, waited for preview recovery, and inspected rendered cards | The broken preview recovered to the original upload URL; the route was not hard-broken                                                                    | `media-library-focused.json`, `media-library-focused.png`                                                        |
...
- `P2` Recoverable stale image-variant pointer on production `/media-library`.
  - Evidence:
