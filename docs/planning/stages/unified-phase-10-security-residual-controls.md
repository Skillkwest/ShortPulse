...
## In Scope
1. Items defined in `docs/planning/shortpulse-unified-buildout-master-plan.md` for Phase 10.
...
✓ Compiled successfully in 1858.5ms
...
✓ Generating static pages using 9 workers (18/18) in 98.7ms
