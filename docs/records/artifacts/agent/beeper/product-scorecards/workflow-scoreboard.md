...
| Character edit -> continuity | 6.0 | `medium` | 2026-05-15 | `partial` | Fresh-session continuity can fail after real edits. | `docs/records/artifacts/agent/beeper/reports/2026-05-15-prod-character-route-bundle.md` |
