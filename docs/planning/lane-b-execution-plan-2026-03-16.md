...
| `B4-01` | B-Core | `/pages/admin/index.tsx` | Split tab-specific controllers and reduce page coupling | `docs/planning/evidence/lane-b/2026-03-17-b4-01-admin-announcements-controller-split.md` | In Progress |
