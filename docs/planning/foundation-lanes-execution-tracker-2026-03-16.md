...
| P1   | In Progress | Engineering | `P0-01` baseline lock is complete; full gate bundle and current payload keyset inventory are frozen, with `P1-01` shared contract gate next | none                                    | `P1-01` shared contract gate                                              | `docs/planning/generation-pipeline-hardening-master-plan-2026-03-16.md` |
