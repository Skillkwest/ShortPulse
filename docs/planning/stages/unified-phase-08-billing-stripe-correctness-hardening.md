...
## In Scope
1. Items defined in `docs/planning/shortpulse-unified-buildout-master-plan.md` for Phase 08.
...
✓ Compiled successfully in 1863.0ms
...
✓ Generating static pages using 9 workers (18/18) in 102.4ms
