...
- Fal runtime v2 operational routes: `/api/fal/webhook` (signature-verified webhook ingestion) and `/api/internal/generation-recovery/run` (cron-secret protected reconciler trigger).
