...
Scope: `ShortPulse/frontend/` (Next.js pages router, client-only).
...
- Don’t introduce a server dependency or backend coupling without an explicit product decision (this repo currently runs client-only).
