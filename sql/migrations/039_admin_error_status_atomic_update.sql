-- Admin incident status hardening:
-- Performs incident status update / event promotion + event linkage atomically
-- within one security-definer RPC callable only by service_role.
