...
| B    | In Progress | Engineering | `B6-01` active; `B5-02` is checkpointed and the scoped AI Studio style literal guard is now enforced against the residual neutral allowlist | none                                    | Decide CI/release wiring for the style guard and owner/date deferred style residuals | `docs/planning/lane-b-master-plan-2026-03-16.md`                        |
