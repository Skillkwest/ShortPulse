...
| Project entry wording | `validated` | Retested the core signed-in `New Project` wording and the adjacent project-library create wording; both now lead where the user expects. | Recheck if the public `New Project` wording remains sales-tilted for returning paid users. | `docs/agents/bopper/workspace/reports/2026-05-15-local-dashboard-new-project-fix-retest.md` |
