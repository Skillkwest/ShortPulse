...
| --------------------------------------------------------------------------------- | ------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- | ----------------------------------- |
| `npm run ophestivus:intake`                                                       | `frontend/scripts/ophestivus_intake.mjs`                | Select the first Backlog ticket or create a new Backlog ticket from the next Admin Errors incident.                     | Yes, unless `--dry-run`             |
