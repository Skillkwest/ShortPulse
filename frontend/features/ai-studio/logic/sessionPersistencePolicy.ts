...
const LEGACY_SESSION_PERSISTENCE_MASTER_ENABLED = isEnabled(
  process.env.NEXT_PUBLIC_AI_STUDIO_LEGACY_SESSION_PERSISTENCE_ENABLED,
  false
);

const SESSION_PERSISTENCE_ENABLED =
  LEGACY_SESSION_PERSISTENCE_MASTER_ENABLED &&
  isEnabled(process.env.NEXT_PUBLIC_AI_STUDIO_SESSION_PERSISTENCE_ENABLED, true);
