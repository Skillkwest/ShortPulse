...
import { useMediaLibraryPanelFolderUiController } from "../hooks/useMediaLibraryPanelFolderUiController";
...
const PROJECT_NAME_PLACEHOLDER = "New AI Studio project";
...
export const MediaLibraryPanel = React.memo(function MediaLibraryPanel({
  ...
  } = useMediaLibraryPanelFolderUiController({
    folders,
    foldersById,
    activeFolderParentId,
    canNavigateUp,
