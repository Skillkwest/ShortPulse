...
- Admin error resolution SOP: `docs/sops/sop_admin_error_to_ophestivus_resolution.md`
...
- Board-helper changes: run `npx eslint scripts/ophestivus_review.mjs scripts/ophestivus_error_status.mjs scripts/ophestivus_intake.mjs` and dry-run the changed helper command.
- Error closeout helper changes: run `npx eslint scripts/ophestivus_complete_error_ticket.mjs scripts/ophestivus_ticket_report.mjs` and `npm run test -- tests/scripts/ophestivus-ticket-report.test.mjs`.
