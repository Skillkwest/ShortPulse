...
| `B5-02` | B-Style | AI Studio style migration | Migrate scoped literal styles to canonical tokens/classes | `docs/planning/evidence/lane-b/2026-03-17-b5-02-expert-inpaint-shell-surface-migration.md` | In Progress |
