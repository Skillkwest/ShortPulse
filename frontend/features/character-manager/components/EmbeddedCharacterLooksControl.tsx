...
const buildTabStyle = (isActive: boolean): React.CSSProperties => ({
  ...
  borderBottomColor: isActive ? "#17191d" : "rgba(201, 205, 214, 0)",
  background: isActive ? "#17191d" : "rgba(39, 40, 43, 0.5)",
  ...
  boxShadow: isActive ? "0 0 0 1px rgba(72, 212, 255, 0.133)" : "none",
