...
export const REFERENCE_GRID_MAX_COLUMNS = 5;
export const REFERENCE_GRID_MAX_COLUMNS_WIDE = 5;
export const QUICK_SLOT_INVENTORY_MAX_COLUMNS = 5;
...
export const REFERENCE_HIGH_DENSITY_CARD_COUNT = 96;
export const REFERENCE_PRIORITY_HYDRATION_ROWS = 3;
export const DEFAULT_CURATED_SPLIT_TOP_RATIO = 0.35;
