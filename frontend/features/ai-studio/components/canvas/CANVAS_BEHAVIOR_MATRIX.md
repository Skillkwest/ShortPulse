...
| Drop external text                 | Plain/prompt text drop                                      | Inserts text canvas item with the same center-on-release anchor used by dropped images, including loading placeholder flow |
