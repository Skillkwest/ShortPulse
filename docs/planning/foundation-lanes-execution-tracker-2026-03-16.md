...
| B    | In Progress | Engineering | B3-02 active; asset controller seam landed and `useCharacterManagerDraft.ts` is reduced to `613` lines | none                                    | Run `B3-02` stop review and decide `character lifecycle` vs checkpoint | `docs/planning/lane-b-master-plan-2026-03-16.md`                        |
