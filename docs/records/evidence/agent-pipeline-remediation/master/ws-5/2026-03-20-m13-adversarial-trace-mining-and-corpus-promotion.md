...
1. `docs/records/artifacts/agent-pipeline-remediation/master/ws-5/artifacts/2026-03-20/adversarial-corpus-lifecycle-sample-packet.json`
...
## Validation
Commands run:
1. `rg -n "adversarial|corpus|trace|promotion" docs/sops/sop_ai_studio_agent_chat_ops.md docs/records/evidence/agent-pipeline-remediation/master/ws-5 -g '*.md' -g '*.json'`
