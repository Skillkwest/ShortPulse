...
| `NEXT_PUBLIC_MEDIA_UPLOAD_API_ENABLED` | removed | Removed from `frontend/.env.example` and active deployment/API docs; server gate remains `SHORTPULSE_MEDIA_UPLOAD_API_ENABLED`. | no active docs/env entry presenting it as live |
