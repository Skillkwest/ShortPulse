...
Purpose: track product issues from discovery through claimed fix through verified retest.

| Issue | Surface | Discovery artifact | Fix claimed? | Retested? | Current status | Notes |
| --- | --- | --- | --- | --- | --- | --- |
| Dashboard AI Studio CTA mismatch | Dashboard | `docs/records/artifacts/agent/d-bug/handoffs/2026-05-15-dashboard-ai-studio-cta-mismatch.md` | No | No | Open | Retest after CTA copy or entry-flow wiring changes. |
| AI Studio generate no-op | AI Studio | `docs/records/artifacts/agent/d-bug/handoffs/2026-05-15-ai-studio-generate-noop.md` | No | No | Open | Needs retest after generate-path fix or runtime change. |
