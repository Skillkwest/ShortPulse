...
- 2026-02-14: Continued `media-library` modularization by extracting bulk-selection move orchestration into a dedicated hook with focused hook tests and page integration.
...
- 2026-02-14: Continued `media-library` modularization by extracting prompt-grid and media-grid/load-more render blocks into dedicated feature components with focused component test coverage and page integration.
...
- 2026-02-14: Continued `media-library` modularization by extracting the filter/search tab-strip block into a dedicated feature component with focused component test coverage and page integration.
