...
| `B6-01` | B-Core/B-Style | convergence | Promote guardrails to enforce after two green cycles | `docs/planning/evidence/lane-b/2026-03-17-b6-01-style-guard-bootstrap.md` | In Progress |
