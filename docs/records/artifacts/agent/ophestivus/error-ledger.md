...
| 2026-05-10 | `7aa4cf2b-1b26-483e-8966-91822ebb4c07` | `b220a307-f50a-4e5d-87b8-815b99e57389` | `Failed to fetch` | `/api/projects/<id>/workspace` | `resolved` | `bounded` | `new-code` | `tests-and-data-verified` | `Monitor` | [r-20260510-workspace-save.md](reports/r-20260510-workspace-save.md) |
