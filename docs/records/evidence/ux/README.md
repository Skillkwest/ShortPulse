...
- `2026-06-02-ai-studio-passive-wheel-warning-audit.md`: retained production audit showing the passive-listener gesture noise is a separate AI Studio wheel-runtime lane from the signed-media preview failures, with restart guidance for a future source-level fix.
