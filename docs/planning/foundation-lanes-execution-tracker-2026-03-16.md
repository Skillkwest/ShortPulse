...
| P1   | In Progress | Engineering | `P0-01` through `P3-01` are complete; submit now fails closed on contract violations and `P3-02` dispatch hardening is next | none                                    | `P3-02` dispatch hardening                                                | `docs/planning/generation-pipeline-hardening-master-plan-2026-03-16.md` |
