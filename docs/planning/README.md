...
- `ai-studio-project-persistence-master-plan-2026-04-23.md`: canonical master plan for replacing legacy AI Studio session persistence with project-owned restore, project-scoped Media Library folders, and globally accessible left-rail libraries.
- `ai-studio-project-persistence-stabilization-trim-and-fix-plan-2026-04-24.md`: historical first stabilization contract for the broader Projects lane, retained for traceability after the active scope narrowed to folder-specific reliability.
- `ai-studio-project-folder-stabilization-trim-and-fix-plan-2026-04-24.md`: active stabilization contract for project folder reliability, unsaved reference persistence into folders, project-scoped folder restore/isolation, and safe trimming of duplicate or dormant folder-lane code.
