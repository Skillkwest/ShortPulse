...
- Run brief path: `docs/agents/bopper/workspace/runs/2026-05-15-202334-dashboard-new-project-retest/run-brief.md`
- Detailed report path: `docs/agents/bopper/workspace/reports/2026-05-15-local-dashboard-new-project-retest.md`
- Checkpoint summary path: `docs/agents/bopper/workspace/checkpoint-summaries/2026-05-15-local-dashboard-new-project-retest-summary.md`
