...
| B    | In Progress | Engineering | `B5-02` active; expert neutral surfaces and secondary controls are now migrated behind scoped tokens, with durable style authority synced | none                                    | Choose the next bounded expert-style cluster after secondary controls     | `docs/planning/lane-b-master-plan-2026-03-16.md`                        |
