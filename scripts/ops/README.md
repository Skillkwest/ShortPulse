...
- `node scripts/ops/gear_ball_preflight.mjs --files <paths...> --tests <tests...>`
  ...
  - Accepts either frontend-relative or repo-root `frontend/...` Vitest paths and can print the normalized frontend-relative target list with `--print-test-manifest`.
