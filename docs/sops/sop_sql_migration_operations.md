...
- `sql/check_runtime_sql_security_audit.sql`: runtime RPC security-definer + execute-grant audit plus canary schema/table/sequence grant checks for app/runtime roles (read-only).
