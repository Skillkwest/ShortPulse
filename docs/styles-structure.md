...
- `styles/ai-studio-presets-library.css`: Unified Presets library shell plus Prompt Presets library styling in the AI Studio properties column.
- `styles/ai-studio-pulse-presets-library.css`: Pulse card and editor styling used inside the unified Presets library.
