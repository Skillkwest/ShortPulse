...
## Evidence Index
1. `docs/records/evidence/agent-pipeline-remediation/phase-3/2026-03-20-phase-3-runtime-scope-telemetry-parity-generate-describe.md`
2. `docs/records/evidence/agent-pipeline-remediation/phase-3/2026-03-20-phase-3-precedence-cache-ttl-proof-tests.md`
3. `docs/records/evidence/agent-pipeline-remediation/phase-3/2026-03-20-phase-3-canary-threshold-decision-utility.md`
4. `docs/records/evidence/agent-pipeline-remediation/phase-3/2026-03-20-phase-3-rollback-drill-local-dry-run.md`
5. `docs/records/evidence/agent-pipeline-remediation/phase-3/2026-03-20-phase-3-staging-canary-delta-packet-generator-tooling.md`
6. `docs/records/evidence/agent-pipeline-remediation/phase-3/2026-03-20-phase-3-staging-live-canary-delta-packet.md`
7. `docs/records/evidence/agent-pipeline-remediation/phase-3/2026-03-20-phase-3-staging-canary-window-sufficiency-waiver.md`
8. `docs/records/evidence/agent-pipeline-remediation/phase-3/2026-03-20-phase-3-staging-rollback-drill-packet.md`
