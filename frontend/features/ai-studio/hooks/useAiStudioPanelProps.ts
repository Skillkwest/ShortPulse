...
import { usePulseCreatePanelProps } from "./pulseCreateRuntime/usePulseCreatePanelProps";
import { useStandardCreatePanelProps } from "./standardCreateRuntime/useStandardCreatePanelProps";
...
export const useAiStudioPanelProps = ({
  ...
  const standardCreateProperties = useStandardCreatePanelProps({
    mode,
    aspect,
    model,
    currentModelLabel,
